...
(function () {
  ...
  var loadPackage = function (metadata) {
    ...
    var PACKAGE_NAME =
      '/home/fabiola/ufabc/03-2022/comp-graf/abcg-comp-grafica-atividade3/public/atividade3.data';
    var REMOTE_PACKAGE_BASE = 'atividade3.data';
    ...
    function runWithFS() {
      ...
      function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](
          'datafile_/home/fabiola/ufabc/03-2022/comp-graf/abcg-comp-grafica-atividade3/public/atividade3.data',
        );
      }
  ...
  loadPackage({
    files: [
      { filename: '/assets/UnlitVertexColor.frag', start: 0, end: 127 },
      { filename: '/assets/UnlitVertexColor.obj', start: 127, end: 201580 },
      { filename: '/assets/UnlitVertexColor.vert', start: 201580, end: 202017 },
    ],
    remote_package_size: 202017,
  });
})();
...
var wasmBinaryFile;
wasmBinaryFile = 'atividade3.wasm';
...
var asmLibraryArg = {
  ...
  jb: __emscripten_get_now_is_monotonic,
  L: _abort,
  Da: _eglBindAPI,
  Pa: _eglChooseConfig,
  ...
  Ja: _eglDestroySurface,
  Oa: _eglGetConfigAttrib,
  $: _eglGetDisplay,
  Ba: _eglGetError,
  Ra: _eglInitialize,
  Ia: _eglMakeCurrent,
  ...
  Ab: _emscripten_glBindTransformFeedback,
  Jc: _emscripten_glBindVertexArray,
  ...
  bd: _emscripten_glDeleteQueries,
  ...
  zb: _emscripten_glDeleteTransformFeedbacks,
  ...
  sf: _emscripten_glDetachShader,
  rf: _emscripten_glDisable,
  qf: _emscripten_glDisableVertexAttribArray,
  pf: _emscripten_glDrawArrays,
  Xb: _emscripten_glDrawArraysInstanced,
  eg: _emscripten_glDrawArraysInstancedANGLE,
  od: _emscripten_glDrawArraysInstancedARB,
  pd: _emscripten_glDrawArraysInstancedEXT,
  kb: _emscripten_glDrawArraysInstancedNV,
  Vc: _emscripten_glDrawBuffers,
  kd: _emscripten_glDrawBuffersEXT,
  ...
  ld: _emscripten_glDrawElementsInstancedARB,
  md: _emscripten_glDrawElementsInstancedEXT,
  nd: _emscripten_glDrawElementsInstancedNV,
  id: _emscripten_glDrawRangeElements,
  mf: _emscripten_glEnable,
  lf: _emscripten_glEnableVertexAttribArray,
  _c: _emscripten_glEndQuery,
  ...
  ac: _emscripten_glGetActiveUniformsiv,
  ...
  qc: _emscripten_glGetFragDataLocation,
  ...
  mb: _emscripten_glGetInternalformativ,
  ub: _emscripten_glGetProgramBinary,
  ...
  Yc: _emscripten_glGetQueryObjectuiv,
  mg: _emscripten_glGetQueryObjectuivEXT,
  Zc: _emscripten_glGetQueryiv,
  og: _emscripten_glGetQueryivEXT,
  Pe: _emscripten_glGetRenderbufferParameteriv,
  Cb: _emscripten_glGetSamplerParameterfv,
  Db: _emscripten_glGetSamplerParameteriv,
  Ne: _emscripten_glGetShaderInfoLog,
  Me: _emscripten_glGetShaderPrecisionFormat,
  Le: _emscripten_glGetShaderSource,
  Oe: _emscripten_glGetShaderiv,
  Ke: _emscripten_glGetString,
  dc: _emscripten_glGetStringi,
  Ob: _emscripten_glGetSynciv,
  Je: _emscripten_glGetTexParameterfv,
  Ie: _emscripten_glGetTexParameteriv,
  zc: _emscripten_glGetTransformFeedbackVarying,
  $b: _emscripten_glGetUniformBlockIndex,
  bc: _emscripten_glGetUniformIndices,
  Fe: _emscripten_glGetUniformLocation,
  He: _emscripten_glGetUniformfv,
  Ge: _emscripten_glGetUniformiv,
  rc: _emscripten_glGetUniformuiv,
  xc: _emscripten_glGetVertexAttribIiv,
  wc: _emscripten_glGetVertexAttribIuiv,
  Ce: _emscripten_glGetVertexAttribPointerv,
  Ee: _emscripten_glGetVertexAttribfv,
  De: _emscripten_glGetVertexAttribiv,
  Be: _emscripten_glHint,
  rb: _emscripten_glInvalidateFramebuffer,
  qb: _emscripten_glInvalidateSubFramebuffer,
  ze: _emscripten_glIsBuffer,
  ye: _emscripten_glIsEnabled,
  xe: _emscripten_glIsFramebuffer,
  we: _emscripten_glIsProgram,
  ad: _emscripten_glIsQuery,
  sg: _emscripten_glIsQueryEXT,
  ve: _emscripten_glIsRenderbuffer,
  Jb: _emscripten_glIsSampler,
  ue: _emscripten_glIsShader,
  Tb: _emscripten_glIsSync,
  te: _emscripten_glIsTexture,
  xb: _emscripten_glIsTransformFeedback,
  Gc: _emscripten_glIsVertexArray,
  gg: _emscripten_glIsVertexArrayOES,
  se: _emscripten_glLineWidth,
  re: _emscripten_glLinkProgram,
  Lc: _emscripten_glMapBufferRange,
  wb: _emscripten_glPauseTransformFeedback,
  qe: _emscripten_glPixelStorei,
  oe: _emscripten_glPolygonOffset,
  tb: _emscripten_glProgramBinary,
  sb: _emscripten_glProgramParameteri,
  pg: _emscripten_glQueryCounterEXT,
  jd: _emscripten_glReadBuffer,
  ne: _emscripten_glReadPixels,
  me: _emscripten_glReleaseShaderCompiler,
  le: _emscripten_glRenderbufferStorage,
  Nc: _emscripten_glRenderbufferStorageMultisample,
  vb: _emscripten_glResumeTransformFeedback,
  ke: _emscripten_glSampleCoverage,
  Fb: _emscripten_glSamplerParameterf,
  Eb: _emscripten_glSamplerParameterfv,
  Hb: _emscripten_glSamplerParameteri,
  Gb: _emscripten_glSamplerParameteriv,
  je: _emscripten_glScissor,
  ie: _emscripten_glShaderBinary,
  he: _emscripten_glShaderSource,
  ge: _emscripten_glStencilFunc,
  fe: _emscripten_glStencilFuncSeparate,
  ee: _emscripten_glStencilMask,
  de: _emscripten_glStencilMaskSeparate,
  ce: _emscripten_glStencilOp,
  be: _emscripten_glStencilOpSeparate,
  ae: _emscripten_glTexImage2D,
  hd: _emscripten_glTexImage3D,
  $d: _emscripten_glTexParameterf,
  _d: _emscripten_glTexParameterfv,
  Zd: _emscripten_glTexParameteri,
  Yd: _emscripten_glTexParameteriv,
  ob: _emscripten_glTexStorage2D,
  nb: _emscripten_glTexStorage3D,
  Xd: _emscripten_glTexSubImage2D,
  gd: _emscripten_glTexSubImage3D,
  Ac: _emscripten_glTransformFeedbackVaryings,
  Wd: _emscripten_glUniform1f,
  Vd: _emscripten_glUniform1fv,
  Ud: _emscripten_glUniform1i,
  Td: _emscripten_glUniform1iv,
  pc: _emscripten_glUniform1ui,
  lc: _emscripten_glUniform1uiv,
  Sd: _emscripten_glUniform2f,
  Rd: _emscripten_glUniform2fv,
  Qd: _emscripten_glUniform2i,
  Pd: _emscripten_glUniform2iv,
  oc: _emscripten_glUniform2ui,
  kc: _emscripten_glUniform2uiv,
  Od: _emscripten_glUniform3f,
  Nd: _emscripten_glUniform3fv,
  Md: _emscripten_glUniform3i,
  Ld: _emscripten_glUniform3iv,
  nc: _emscripten_glUniform3ui,
  jc: _emscripten_glUniform3uiv,
  Kd: _emscripten_glUniform4f,
  Jd: _emscripten_glUniform4fv,
  Id: _emscripten_glUniform4i,
  Hd: _emscripten_glUniform4iv,
  mc: _emscripten_glUniform4ui,
  ic: _emscripten_glUniform4uiv,
  Yb: _emscripten_glUniformBlockBinding,
  Gd: _emscripten_glUniformMatrix2fv,
  Uc: _emscripten_glUniformMatrix2x3fv,
  Sc: _emscripten_glUniformMatrix2x4fv,
  Fd: _emscripten_glUniformMatrix3fv,
  Tc: _emscripten_glUniformMatrix3x2fv,
  Qc: _emscripten_glUniformMatrix3x4fv,
  Ed: _emscripten_glUniformMatrix4fv,
  Rc: _emscripten_glUniformMatrix4x2fv,
  Pc: _emscripten_glUniformMatrix4x3fv,
  Xc: _emscripten_glUnmapBuffer,
  Dd: _emscripten_glUseProgram,
  Cd: _emscripten_glValidateProgram,
  Bd: _emscripten_glVertexAttrib1f,
  Ad: _emscripten_glVertexAttrib1fv,
  zd: _emscripten_glVertexAttrib2f,
  yd: _emscripten_glVertexAttrib2fv,
  xd: _emscripten_glVertexAttrib3f,
  wd: _emscripten_glVertexAttrib3fv,
  vd: _emscripten_glVertexAttrib4f,
  ud: _emscripten_glVertexAttrib4fv,
  Bb: _emscripten_glVertexAttribDivisor,
  cg: _emscripten_glVertexAttribDivisorANGLE,
  qd: _emscripten_glVertexAttribDivisorARB,
  rd: _emscripten_glVertexAttribDivisorEXT,
  lb: _emscripten_glVertexAttribDivisorNV,
  vc: _emscripten_glVertexAttribI4i,
  tc: _emscripten_glVertexAttribI4iv,
  uc: _emscripten_glVertexAttribI4ui,
  sc: _emscripten_glVertexAttribI4uiv,
  yc: _emscripten_glVertexAttribIPointer,
  td: _emscripten_glVertexAttribPointer,
  sd: _emscripten_glViewport,
  Qb: _emscripten_glWaitSync,
  K: _emscripten_has_asyncify,
  fb: _emscripten_memcpy_big,
  wg: _emscripten_request_fullscreen_strategy,
  _: _emscripten_request_pointerlock,
  cb: _emscripten_resize_heap,
  Ub: _emscripten_run_script,
  ba: _emscripten_sample_gamepad_data,
  sa: _emscripten_set_beforeunload_callback_on_thread,
  S: _emscripten_set_blur_callback_on_thread,
  l: _emscripten_set_canvas_element_size,
  I: _emscripten_set_element_css_size,
  T: _emscripten_set_focus_callback_on_thread,
  N: _emscripten_set_fullscreenchange_callback_on_thread,
  ...
  pe: _emscripten_set_main_loop_arg,
  Y: _emscripten_set_mousedown_callback_on_thread,
  ...
  ya: _emscripten_set_pointerlockchange_callback_on_thread,
  ua: _emscripten_set_resize_callback_on_thread,
  O: _emscripten_set_touchcancel_callback_on_thread,
  Q: _emscripten_set_touchend_callback_on_thread,
  P: _emscripten_set_touchmove_callback_on_thread,
  R: _emscripten_set_touchstart_callback_on_thread,
  ta: _emscripten_set_visibilitychange_callback_on_thread,
  U: _emscripten_set_wheel_callback_on_thread,
  xg: _emscripten_set_window_title,
  J: _emscripten_sleep,
  db: _environ_get,
...
var ___wasm_call_ctors = (Module['___wasm_call_ctors'] = function () {
  return (___wasm_call_ctors = Module['___wasm_call_ctors'] = Module['asm']['zg']).apply(
    null,
    arguments,
  );
});
...
var ___errno_location = (Module['___errno_location'] = function () {
  return (___errno_location = Module['___errno_location'] = Module['asm']['Bg']).apply(
    null,
    arguments,
  );
});
var _fflush = (Module['_fflush'] = function () {
  return (_fflush = Module['_fflush'] = Module['asm']['Cg']).apply(null, arguments);
});
var _malloc = (Module['_malloc'] = function () {
  return (_malloc = Module['_malloc'] = Module['asm']['Dg']).apply(null, arguments);
});
var _free = (Module['_free'] = function () {
  return (_free = Module['_free'] = Module['asm']['Eg']).apply(null, arguments);
});
var ___funcs_on_exit = (Module['___funcs_on_exit'] = function () {
  return (___funcs_on_exit = Module['___funcs_on_exit'] = Module['asm']['Fg']).apply(
    null,
    arguments,
  );
});
var stackSave = (Module['stackSave'] = function () {
  return (stackSave = Module['stackSave'] = Module['asm']['Hg']).apply(null, arguments);
});
var stackRestore = (Module['stackRestore'] = function () {
  return (stackRestore = Module['stackRestore'] = Module['asm']['Ig']).apply(null, arguments);
});
var stackAlloc = (Module['stackAlloc'] = function () {
  return (stackAlloc = Module['stackAlloc'] = Module['asm']['Jg']).apply(null, arguments);
});
var ___cxa_is_pointer_type = (Module['___cxa_is_pointer_type'] = function () {
  return (___cxa_is_pointer_type = Module['___cxa_is_pointer_type'] = Module['asm']['Kg']).apply(
    null,
    arguments,
  );
});
var dynCall_jiji = (Module['dynCall_jiji'] = function () {
  return (dynCall_jiji = Module['dynCall_jiji'] = Module['asm']['Lg']).apply(null, arguments);
});
var dynCall_ji = (Module['dynCall_ji'] = function () {
  return (dynCall_ji = Module['dynCall_ji'] = Module['asm']['Mg']).apply(null, arguments);
});
var dynCall_viijii = (Module['dynCall_viijii'] = function () {
  return (dynCall_viijii = Module['dynCall_viijii'] = Module['asm']['Ng']).apply(null, arguments);
});
var dynCall_iiiiij = (Module['dynCall_iiiiij'] = function () {
  return (dynCall_iiiiij = Module['dynCall_iiiiij'] = Module['asm']['Og']).apply(null, arguments);
});
var dynCall_iiiiijj = (Module['dynCall_iiiiijj'] = function () {
  return (dynCall_iiiiijj = Module['dynCall_iiiiijj'] = Module['asm']['Pg']).apply(null, arguments);
});
var dynCall_iiiiiijj = (Module['dynCall_iiiiiijj'] = function () {
  return (dynCall_iiiiiijj = Module['dynCall_iiiiiijj'] = Module['asm']['Qg']).apply(
    null,
    arguments,
  );
});
